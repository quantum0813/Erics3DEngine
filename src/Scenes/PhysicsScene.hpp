#ifndef ERICS3DENGINE_PHYSICSSCENE_HPP
#define ERICS3DENGINE_PHYSICSSCENE_HPP
...
class PhysicsScene : public Scene {
    public:
        PhysicsScene(GLFWwindow * window) : Scene(window) {}
        ~PhysicsScene();
...
#endif //ERICS3DENGINE_PHYSICSSCENE_HPP