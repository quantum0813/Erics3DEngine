#ifndef ERICS3DENGINE_JULIASCENE_HPP
#define ERICS3DENGINE_JULIASCENE_HPP
...
class JuliaScene : public Scene {
    public:
        JuliaScene(GLFWwindow * window) : mPaused(false), mTimeOffset(0.0f), mZoom(1.0f), mXOffset(0.0f), mYOffset(0.0f), Scene(window) {}
        ~JuliaScene();
    ...
    private:
        Program * mProgram;
        GLuint mVAO;
        GLuint mPaletteTexture;

        GLuint mUniformZoom;
        GLuint mUniformOffset;
        GLuint mUniformC;
...
#endif //ERICS3DENGINE_JULIASCENE_HPP
